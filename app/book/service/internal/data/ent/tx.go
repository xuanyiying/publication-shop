...
func (tx *Tx) init() {
	...
	tx.BookDetail = NewBookDetailClient(tx.config)
	tx.BookImage = NewBookImageClient(tx.config)
	tx.BookStock = NewBookStockClient(tx.config)
	tx.BookXCatalog = NewBookXCatalogClient(tx.config)
	tx.BookXClassic = NewBookXClassicClient(tx.config)
	tx.BookXLanguage = NewBookXLanguageClient(tx.config)
