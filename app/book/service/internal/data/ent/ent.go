...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			bookdetail.Table:    bookdetail.ValidColumn,
			bookimage.Table:     bookimage.ValidColumn,
			bookstock.Table:     bookstock.ValidColumn,
			bookxcatalog.Table:  bookxcatalog.ValidColumn,
			bookxclassic.Table:  bookxclassic.ValidColumn,
			bookxlanguage.Table: bookxlanguage.ValidColumn,
