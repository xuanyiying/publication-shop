...
func (aq *AuthorQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (aq *AuthorQuery) FirstIDX(ctx context.Context) int32 {
...
func (aq *AuthorQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (aq *AuthorQuery) OnlyIDX(ctx context.Context) int32 {
...
func (aq *AuthorQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (aq *AuthorQuery) IDsX(ctx context.Context) []int32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AuthorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(author.Table, author.Columns, sqlgraph.NewFieldSpec(author.FieldID, field.TypeInt32))
	_spec.From = aq.sql
