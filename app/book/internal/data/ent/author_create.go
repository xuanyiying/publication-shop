...
func (ac *AuthorCreate) SetBiography(s string) *AuthorCreate {
	ac.mutation.SetBiography(s)
	return ac
}

// SetNillableBiography sets the "biography" field if the given value is not nil.
func (ac *AuthorCreate) SetNillableBiography(s *string) *AuthorCreate {
	if s != nil {
		ac.SetBiography(*s)
	}
	return ac
...
func (ac *AuthorCreate) SetID(i int32) *AuthorCreate {
	ac.mutation.SetID(i)
	return ac
}
...
func (ac *AuthorCreate) createSpec() (*Author, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(author.Table, sqlgraph.NewFieldSpec(author.FieldID, field.TypeInt32))
	)
	...
	if value, ok := ac.mutation.Biography(); ok {
