...
func (pq *PublisherQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (pq *PublisherQuery) FirstIDX(ctx context.Context) int {
...
func (pq *PublisherQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (pq *PublisherQuery) OnlyIDX(ctx context.Context) int {
...
func (pq *PublisherQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (pq *PublisherQuery) IDsX(ctx context.Context) []int {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(publisher.FieldPublisherName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Publisher.Query().
//		Select(publisher.FieldPublisherName).
//		Scan(ctx, &v)
...
func (pq *PublisherQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(publisher.Table, publisher.Columns, sqlgraph.NewFieldSpec(publisher.FieldID, field.TypeInt))
	_spec.From = pq.sql
