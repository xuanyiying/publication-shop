...
func (bq *BookQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BookQuery) FirstIDX(ctx context.Context) int64 {
...
func (bq *BookQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BookQuery) OnlyIDX(ctx context.Context) int64 {
...
func (bq *BookQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (bq *BookQuery) IDsX(ctx context.Context) []int64 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
