...
import (
	...
	"github.com/go-kratos/publication-shop/app/catalog/service/internal/data/ent/language"
	...
	"github.com/go-kratos/publication-shop/app/catalog/service/internal/data/ent/user"
	"sync"
	"time"
...
func (m *PublicationInfoMutation) SetQuantity(i int32) {
	m.quantity = &i
	m.addquantity = nil
}

// Quantity returns the value of the "quantity" field in the mutation.
func (m *PublicationInfoMutation) Quantity() (r int32, exists bool) {
	v := m.quantity
	if v == nil {
		return
	}
...
// OldQuantity returns the old "quantity" field's value of the PublicationInfo entity.
// If the PublicationInfo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PublicationInfoMutation) OldQuantity(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PublicationInfoMutation) AddQuantity(i int32) {
...
func (m *PublicationInfoMutation) AddedQuantity() (r int32, exists bool) {
	v := m.addquantity
	if v == nil {
		return
	}
...
func (m *PublicationInfoMutation) ClearQuantity() {
	m.quantity = nil
	m.addquantity = nil
	m.clearedFields[publicationinfo.FieldQuantity] = struct{}{}
}

// QuantityCleared returns if the "quantity" field was cleared in this mutation.
func (m *PublicationInfoMutation) QuantityCleared() bool {
	_, ok := m.clearedFields[publicationinfo.FieldQuantity]
	return ok
}

// ResetQuantity resets all changes to the "quantity" field.
func (m *PublicationInfoMutation) ResetQuantity() {
	m.quantity = nil
	m.addquantity = nil
	delete(m.clearedFields, publicationinfo.FieldQuantity)
}
...
func (m *PublicationInfoMutation) Fields() []string {
	...
	if m.quantity != nil {
		fields = append(fields, publicationinfo.FieldQuantity)
	}
	if m.word_count != nil {
...
func (m *PublicationInfoMutation) Field(name string) (ent.Value, bool) {
	...
	case publicationinfo.FieldQuantity:
		return m.Quantity()
...
func (m *PublicationInfoMutation) ClearedFields() []string {
	...
	if m.FieldCleared(publicationinfo.FieldQuantity) {
		fields = append(fields, publicationinfo.FieldQuantity)
	}
