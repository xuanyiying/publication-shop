...
func (pic *PublicationInfoCreate) SetQuantity(i int32) *PublicationInfoCreate {
	pic.mutation.SetQuantity(i)
	return pic
}

// SetNillableQuantity sets the "quantity" field if the given value is not nil.
func (pic *PublicationInfoCreate) SetNillableQuantity(i *int32) *PublicationInfoCreate {
	if i != nil {
		pic.SetQuantity(*i)
	}
	return pic
