...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PublicationInfo, c.PublicationOrg, c.PublicationXCatalog,
		c.PublicationXClassic, c.PublicationXLanguage, c.User,
	} {
		n.Use(hooks...)
	}
}
...
func (c *PublicationInfoClient) Get(ctx context.Context, id int64) (*PublicationInfo, error) {
...
type (
	hooks struct {
		...
		PublicationInfo, PublicationOrg, PublicationXCatalog, PublicationXClassic,
		PublicationXLanguage, User []ent.Hook
	}
	inters struct {
		Catalog, Classic, Language, PublicationAuthor, PublicationDetail,
		PublicationInfo, PublicationOrg, PublicationXCatalog, PublicationXClassic,
		PublicationXLanguage, User []ent.Interceptor
	}
)
