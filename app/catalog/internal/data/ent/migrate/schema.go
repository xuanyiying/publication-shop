...
var (
	...
	// PublicationImgColumns holds the columns for the "publication_img" table.
	PublicationImgColumns = []*schema.Column{
	...
	// PublicationImgTable holds the schema information for the "publication_img" table.
	PublicationImgTable = &schema.Table{
		Name:       "publication_img",
		Columns:    PublicationImgColumns,
		PrimaryKey: []*schema.Column{PublicationImgColumns[0]},
	}
	...
	// PublicationStockColumns holds the columns for the "publication_stock" table.
	PublicationStockColumns = []*schema.Column{
		{Name: "stock_id", Type: field.TypeInt, Increment: true},
		{Name: "isbn", Type: field.TypeString},
		{Name: "quantity", Type: field.TypeInt, Nullable: true},
		{Name: "publication_id", Type: field.TypeInt, Nullable: true},
	}
	// PublicationStockTable holds the schema information for the "publication_stock" table.
	PublicationStockTable = &schema.Table{
		Name:       "publication_stock",
		Columns:    PublicationStockColumns,
		PrimaryKey: []*schema.Column{PublicationStockColumns[0]},
	}
...
func init() {
	...
	PublicationImgTable.Annotation = &entsql.Annotation{
	...
	PublicationStockTable.Annotation = &entsql.Annotation{
