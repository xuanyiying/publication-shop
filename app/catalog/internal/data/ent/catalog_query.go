...
func (cq *CatalogQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (cq *CatalogQuery) FirstIDX(ctx context.Context) int {
...
func (cq *CatalogQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (cq *CatalogQuery) OnlyIDX(ctx context.Context) int {
...
func (cq *CatalogQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (cq *CatalogQuery) IDsX(ctx context.Context) []int {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(catalog.FieldCatalogCode).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Catalog.Query().
//		Select(catalog.FieldCatalogCode).
//		Scan(ctx, &v)
...
func (cq *CatalogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(catalog.Table, catalog.Columns, sqlgraph.NewFieldSpec(catalog.FieldID, field.TypeInt))
	_spec.From = cq.sql
